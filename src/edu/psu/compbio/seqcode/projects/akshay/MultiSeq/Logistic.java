...
public class Logistic extends AbstractClassifier implements OptionHandler,
  ...
  public void setSmDebug(boolean smDebug){sm_Debug=smDebug;}
  public boolean getSmDebug(){return sm_Debug;}
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    setDebug(Utils.getFlag("SDB", options));
  ...
  private class OptObject {
    ...
    protected double[] evaluateGradient(double[] x) {
      ...
      if(getSmDebug()){
    	  ...
    	  for(int w = 0; w<dim; w++){
    		  for(int offset=0; offset<m_NumClasses-1;offset++){
    			  sb.append(x[offset+w]);sb.append("\t");
    		  }
