package edu.psu.compbio.seqcode.machinelearning.clustering;
...
public class DefaultCluster<X> implements Cluster<X> {
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.clustering.Cluster#getElements()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.clustering.Cluster#size()
	 */
	public int size() {
		return elmts.size();
	}
