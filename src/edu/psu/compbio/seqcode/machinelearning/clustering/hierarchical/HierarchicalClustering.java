package edu.psu.compbio.seqcode.machinelearning.clustering.hierarchical;
...
import edu.psu.compbio.seqcode.machinelearning.clustering.SingletonCluster;
...
public class HierarchicalClustering<X> implements ClusteringMethod<X> {
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.clustering.ClusteringMethod#clusterElements(java.util.Collection)
     */
