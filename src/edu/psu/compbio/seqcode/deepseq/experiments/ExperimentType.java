...
/**
 * ExperimentType is a collection of ControlledExperiments representing a set of experiments that all share the same experimental type.  
 * 
 * @author Shaun Mahony
 * @version	%I%, %G%
 */
public class ExperimentType {
	...
	public List<ExperimentCondition> getExptTypeConditions(){return conditions;}
	public List<ControlledExperiment> getExptTypeExperiments(){return replicates;}
