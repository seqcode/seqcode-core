...
public class ChipChipDataset {
    ...
    public ChipChipData getData(String exptname, String version) throws NotFoundException {
        return new edu.psu.compbio.seqcode.gse.datasets.chipchip.SQLData(exptname,version,genome.getDBID(),null);
    }
    public ChipChipData getData(ExptNameVersion env) throws NotFoundException {
        ...
        return new edu.psu.compbio.seqcode.gse.datasets.chipchip.SQLData(env.name,env.version,genome.getDBID(),repls);
    }
    public ChipChipData getWCE(String exptname, String version) throws NotFoundException {
        return new edu.psu.compbio.seqcode.gse.datasets.chipchip.SQLDataWCEVals(exptname,version,genome.getDBID(),null);
    }
    public ChipChipData getWCE(ExptNameVersion env) throws NotFoundException {
        ...
        return new edu.psu.compbio.seqcode.gse.datasets.chipchip.SQLDataWCEVals(env.name,env.version,genome.getDBID(),repls);
    }
