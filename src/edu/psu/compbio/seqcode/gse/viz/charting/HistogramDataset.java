 ...
 */
package edu.psu.compbio.seqcode.gse.viz.charting;
...
public class HistogramDataset implements IntervalXYDataset {
    ...
    private static Logger logger = Logger.getLogger("edu.psu.compbio.seqcode.gse.viz.charting.HistogramDataset");
