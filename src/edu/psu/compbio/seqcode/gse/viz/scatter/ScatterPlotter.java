package edu.psu.compbio.seqcode.gse.viz.scatter;
 ...
 * This class codes the application frame that drives a GUI version of the scatter plot generator. 
 * 
...
public class ScatterPlotter extends ApplicationFrame implements ActionListener {
    ...
    //Modifiers
    public void setWidth(int w){scatter.setWidth(w); chartPanel.setPreferredSize(new java.awt.Dimension(scatter.getWidth(), scatter.getHeight()));}
    public void setHeight(int h){scatter.setHeight(h);  chartPanel.setPreferredSize(new java.awt.Dimension(scatter.getWidth(), scatter.getHeight()));}

    public boolean isBatch(){return scatter.isBatch();}
    public ScatterPlot getScatterPlot(){return scatter;}
    /**
