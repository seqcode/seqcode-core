...
import edu.psu.compbio.seqcode.gse.utils.NamedValue;
...
public class NamedListPanel<X> extends JPanel implements ListPanel<X>, ListPanelListener {
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#getNumValues()
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#getValue(int)
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#addValue(null)
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#clear()
     */
    public void clear() {
        simpleList.clear();
    }
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#getFirstSelectedValue()
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanel#getSelectedValues()
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanelEventSource#addListPanelListener(edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanelListener)
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanelEventSource#removeListPanelListener(edu.psu.compbio.seqcode.gse.hyperdrive.ui.ListPanelListener)
     */
