...
public class SelectionDialog extends JDialog implements EventSource<SelectionEvent> {
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.utils.EventSource#addEventListener(edu.psu.compbio.seqcode.gse.utils.Listener)
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.utils.EventSource#removeEventListener(edu.psu.compbio.seqcode.gse.utils.Listener)
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.utils.EventSource#hasListeners()
     */
