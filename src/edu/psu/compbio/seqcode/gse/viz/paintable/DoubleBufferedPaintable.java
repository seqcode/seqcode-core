...
public class DoubleBufferedPaintable implements Paintable, PaintableChangedListener {
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.viz.paintable.Paintable#addPaintableChangedListener(edu.psu.compbio.seqcode.gse.viz.paintable.PaintableChangedListener)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.viz.paintable.Paintable#getPaintableActions()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.viz.paintable.Paintable#getSaveImageAction()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.viz.paintable.Paintable#registerClick(double, double)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.viz.paintable.Paintable#removePaintableChangedListener(edu.psu.compbio.seqcode.gse.viz.paintable.PaintableChangedListener)
	 */
