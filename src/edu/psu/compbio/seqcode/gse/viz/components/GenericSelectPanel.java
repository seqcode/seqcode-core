...
public abstract class GenericSelectPanel<X> extends JSplitPane implements Closeable, Runnable {
    ...
    /* asyncSelected is here so you can call addToSelected() while updateComponents()
       is running.  Since updateComponents probably starts by clearing them, your changes will
       be lost.  By sticking things in asyncSelected and then adding them at the end, your
       additions will be kept
    */
    ...
    /* sets the genome and starts a new thread to process that change.
    ...
    */
    ...
    public boolean handlingNewGenome() {return handlingNewGenome;}
    ...
    public void init(JTable filteredList, 
        ...
        JPanel selPanel = new JPanel(); selPanel.setLayout(new BorderLayout());
    ...
    /* returns the elements of the filtered list that should be added to
       the selected list when the "add" button is pressed */
    ...
    public int getNumSelected() { return selectedModel.getSize(); }
