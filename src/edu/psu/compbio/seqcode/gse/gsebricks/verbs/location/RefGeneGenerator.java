 ...
 *   
 *   reads the properties file edu.psu.compbio.seqcode.gse.gsebricks.verbs.gene_names which is formatted as 
...
public class RefGeneGenerator<X extends Region> 
    ...
    public void setGenome(Genome g, String t) { 
        genome = g;
        ResourceBundle res = ResourceBundle.getBundle("edu.psu.compbio.seqcode.gse.gsebricks.gene_names");
