...
import edu.psu.compbio.seqcode.gse.utils.json.JSONArray;
import edu.psu.compbio.seqcode.gse.utils.json.JSONException;
import edu.psu.compbio.seqcode.gse.utils.json.JSONObject;
	...
	public JSONObject asJSON() { 
		...
		for(int i = 0; i < fs.length; i++) {
			...
			if(!isStatic) { 
				...
				} catch (edu.psu.compbio.seqcode.gse.utils.json.JSONException e) {
