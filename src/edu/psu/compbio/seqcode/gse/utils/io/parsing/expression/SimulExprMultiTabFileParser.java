 ...
 * @author tdanford
 */
public class SimulExprMultiTabFileParser implements edu.psu.compbio.seqcode.gse.utils.Closeable {
    ...
    private class InnerIterator implements Iterator<ExprProbeValue> {
        ...
        /* (non-Javadoc)
         * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Iterator#hasNext()
         */
        ...
        /* (non-Javadoc)
         * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Iterator#next()
         */
        ...
        /* (non-Javadoc)
         * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Iterator#getDescriptor()
         */
