 ...
 */
public class FASTAStream implements Iterator<Pair<String,String>>, edu.psu.compbio.seqcode.gse.utils.Closeable {
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Stream#hasNext()
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Stream#next()
     */
    ...
    /* (non-Javadoc)
     * @see edu.psu.compbio.seqcode.gse.hyperdrive.utils.Stream#getDescriptor()
     */
