...
public class DirectedCycleChecker implements CycleChecker {
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.utils.graphs.CycleChecker#containsCycle()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.psu.compbio.seqcode.gse.utils.graphs.CycleChecker#checkCycleWithEdge(java.lang.String, java.lang.String)
	 */
