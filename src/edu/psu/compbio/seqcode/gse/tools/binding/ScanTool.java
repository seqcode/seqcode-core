...
import edu.psu.compbio.seqcode.gse.conservation.CustomMSPBindingGenerator;
import edu.psu.compbio.seqcode.gse.conservation.SimpleMSPBindingGenerator;
...
public class ScanTool {
    ...
    public static class HMMCallerMapper implements CallerMapper {
        ...
        public HMMCallerMapper(BindingParameters bp) { 
            ...
            config = bp.getString("config", "edu.psu.compbio.seqcode.gse.projects.ppg.3state_optimized_HMM");
