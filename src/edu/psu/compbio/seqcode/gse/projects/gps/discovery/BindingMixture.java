package edu.psu.compbio.seqcode.gse.projects.gps.discovery;
...
//	}//end of normExpts method
	...
	private double calcSlope(List<PairedCountData> scalePairs) {
        ...
        DataFrame df = new DataFrame(edu.psu.compbio.seqcode.gse.projects.gps.PairedCountData.class, scalePairs.iterator());
