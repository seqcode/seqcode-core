 ...
 * 
 */
package edu.psu.compbio.seqcode.gse.projects.gps.discovery.hmm;
...
import edu.psu.compbio.seqcode.gse.utils.numeric.Numerical;
...
//      return hmm_LogAdjustedTransProb.ceilingEntry(maxStateLength).getValue();
   ...
   * (non-Javadoc)
   * 
   * @see edu.psu.compbio.seqcode.gse.shaun.deepseq.discovery.FeatureFinder#printError()
   */
  @Override
