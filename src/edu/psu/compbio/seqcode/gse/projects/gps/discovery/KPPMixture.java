...
import edu.psu.compbio.seqcode.gse.projects.gps.discovery.kmer.Kmer;
import edu.psu.compbio.seqcode.gse.projects.gps.discovery.kmer.KmerSet;
...
//            }
	...
	private static double calcSlope(List<PairedCountData> scalePairs, double excludedFraction, boolean dumpRegression) {
        ...
        DataFrame df = new DataFrame(edu.psu.compbio.seqcode.gse.projects.gps.PairedCountData.class, selectedPairs.iterator());
