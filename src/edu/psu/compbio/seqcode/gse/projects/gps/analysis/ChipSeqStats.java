package edu.psu.compbio.seqcode.gse.projects.gps.analysis;
...
import edu.psu.compbio.seqcode.gse.projects.gps.utilities.FivePrimeProfiler;
...
//		model_minus.printToFile(expt+"_minus_Distribution.txt");
	...
	private static MetaProfile buildMetaPeak (List<Point> points, String expt, String version, char strand){
		...
		try{
			...
			FivePrimeProfiler profiler = new FivePrimeProfiler(params, exptexps, strand, 2);
