...
public class SeqViewOptionsFrame extends JFrame implements ActionListener {
    ...
    public SeqViewOptionsFrame() throws NotFoundException {
        super();
        setTitle("SeqView");
    ...
    public SeqViewOptionsFrame(String species, String genome) throws NotFoundException {
        super();
    ...
    public SeqViewOptionsFrame(SeqViewOptions opts) throws NotFoundException {
        super();
        setTitle("SeqView");
        pcs = new ArrayList<PainterContainer>();
    ...
    public static void main(String args[]) {        
        try {
        	SeqViewOptionsFrame.configureLogging();
        	SeqViewOptions opts = SeqViewOptions.parseCL(args);
			new SeqViewOptionsFrame(opts);
		} catch (Exception e) {
			e.printStackTrace();
		}
    }
