		...
		public AboutMessage(String version) {
			...
			try {
				...
				String text = "<html><center>" + "<p>" + version + "<p>" + "<p>Written by Shaun Mahony" + "<p>"
						+ "<p>An editor for SeqData DB experiment entries. " + "</html>";
				...
				if (iconlabel != null)
					...
					javax.swing.JLabel svlabel = new javax.swing.JLabel(new String(
							"<html><center><font size=\"+2\" color=\"blue\">SeqDataExperimentEditor</font></html>"));
