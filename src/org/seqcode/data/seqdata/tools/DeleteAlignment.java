...
/**
 * Delete the SeqAlignment entry associated with the alignment ID specified on
 * the command line. SeqExpt entries and other tables are edited if the
 * SeqAlignment deletion leaves orphans.
 * 
