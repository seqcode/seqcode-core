...
/**
 * Update existing SeqExpt & SeqAlignment descriptions from a file. This imports
 * a file like deepseq.list when populating a new installation of the seqdata
 * mysql database.
 * 
 * @author mahony
 *
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				if (!fields[0].equals("ReadDBID") && !fields[0].startsWith("#")) {// skip
					...
					// Have to load alignment and experiment by DBID since the
					// naming may change
					SeqExpt expt = null;
					...
					if (alignment == null) {
						...
						throw new DatabaseException(
								"Can't find alignment " + dbid + " for " + alignpieces[2] + " for " + alignpieces[0]);
					} else {
						// Update experiment
						...
						try {
							...
							// cxn.rollback();
							System.err.println("No experiment found for " + alignpieces[0] + ";" + alignpieces[1] + ";"
									+ alignpieces[2]);
							System.exit(1);
						}
						if (exptExists) {
							System.err.println("Updating experiment " + alignpieces[0] + ";" + alignpieces[1] + ";"
									+ alignpieces[2]);
							...
							try {
								...
								/*
								 * failed again means the update failed. you
								 * lose
								 */
								// cxn.rollback();
								throw new DatabaseException(
										"Couldn't update experiment for " + alignpieces[0] + "," + alignpieces[1]);
							}
						}
						...
						try {
							...
							System.err.println("Updating alignment " + alignpieces[0] + ";" + alignpieces[1] + ";"
									+ alignpieces[2]);
