 ...
 * 
 * 
 *         create table seqexpt ( id int(10) not null auto_increment, name
 *         varchar(200) not null, replicate varchar(200) not null, species
 *         int(10) not null, expttype int(10) not null, lab int(10) not null,
 *         exptcondition int(10) not null, expttarget int(10) not null, cellline
 *         int(10) not null, readtype int(10) not null, readlength int(5) not
 *         null, numreads int(12), collabid varchar(200), publicsource
 *         varchar(200), publicdbid varchar(200), fqfile varchar(500), exptnote
 *         longtext, unique (id), index (name, replicate, expttype, lab,
 *         exptcondition, expttarget, cellline), primary key (name, replicate)
 *         )Type=InnoDB;
 */
public class SeqExpt implements Comparable<SeqExpt> {
	...
	public ExptType getExptType() {
		return type;
	}

	public ExptTarget getExptTarget() {
		return target;
	}
	...
	public ExptCondition getExptCondition() {
		return condition;
	}
	...
	public static PreparedStatement createLoadAll(java.sql.Connection c) throws SQLException {
		return c.prepareStatement(
				"select id, name, replicate, species, expttype, lab, exptcondition, expttarget, cellline, readtype, readlength, numreads, collabid, publicsource, publicdbid, fqfile, exptnote from seqexpt");
	}

	public static PreparedStatement createLoadByDBID(java.sql.Connection c) throws SQLException {
		return c.prepareStatement(
				"select id, name, replicate, species, expttype, lab, exptcondition, expttarget, cellline, readtype, readlength, numreads, collabid, publicsource, publicdbid, fqfile, exptnote from seqexpt where id=?");
	}
	...
	public static PreparedStatement createInsert(java.sql.Connection c) throws SQLException {
		String query = String
				.format("insert into seqexpt (name, replicate, species, expttype, lab, exptcondition, expttarget, cellline, readtype, readlength, numreads, collabid, publicsource, publicdbid, fqfile, exptnote) "
						+ "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public static PreparedStatement createInsertWithID(java.sql.Connection c) throws SQLException {
		String query = String
				.format("insert into seqexpt (id, name, replicate, species, expttype, lab, exptcondition, expttarget, cellline, readtype, readlength, numreads, collabid, publicsource, publicdbid, fqfile, exptnote) "
						+ "values (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
		return c.prepareStatement(query);
	}
	...
	public static PreparedStatement createUpdateWithID(java.sql.Connection c) throws SQLException {
		String query = String
				.format("update seqexpt set name=?, replicate=?, species=?, expttype=?, lab=?, exptcondition=?, expttarget=?, cellline=?, readtype=?, readlength=?, numreads=?, collabid=?, publicsource=?, publicdbid=?, fqfile=?, exptnote=? "
						+ " where id=?");
		return c.prepareStatement(query);
	}
	...
	public static PreparedStatement createShortUpdateWithID(java.sql.Connection c) throws SQLException {
		String query = String
				.format("update seqexpt set name=?, replicate=?, species=?, expttype=?, lab=?, exptcondition=?, expttarget=?, cellline=?, collabid=?, publicsource=?, publicdbid=? "
						+ " where id=?");
		return c.prepareStatement(query);
	}
