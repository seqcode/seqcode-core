...
public interface BackgroundModelFrequencySupport {
	...
	/**
	 * Get the probability for the kmer corresponding to the specified intVal
	 * and kmerLen from the distribution of all kmers of that length
	 * 
	 * @param intVal
	 *            the integer representation of the kmer to lookup
	 * @param kmerLen
	 *            the length of the kmer to lookup
	 * @return
	 */
