...
public class WeightMatrixLoader implements org.seqcode.gseutils.Closeable {
	...
	private Collection<String> queryWMTable(String field) {
		try {
			...
			PreparedStatement ps = cxn
					.prepareStatement("select unique(" + field + ") from weightmatrix order by " + field);
	...
	public WeightMatrix query(int speciesid, String name, String version) {
	...
	public Collection<WeightMatrix> query(String name, String version, String type) {
