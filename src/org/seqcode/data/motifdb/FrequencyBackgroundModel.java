...
public class FrequencyBackgroundModel extends BackgroundModel implements BackgroundModelFrequencySupport {
	...
	/**
	 * Construct a new FrequencyBackgroundModel from the supplied metadata
	 * object
	 * 
	 * @param md
	...
	/**
	 * Construct a new FrequencyBackground model with the specified name, for
	 * the specified genome, and with a default max kmer length
	 * 
	 * @param name
	 * @param gen
	 */
	...
	/**
	 * Construct a new FrequencyBackground model with the specified name, for
	 * the specified genome, and with the specified max kmer length
	 * 
	 * @param name
	 * @param gen
	 * @param maxKmerLen
	...
	/**
	 * Construct a FrequencyBackgroundModel from an existing
	 * CountsBackgroundModel
	 * 
	 * @param cbg
	 *            the existing CountsBackgroundModel
	 */
	 ...
	 * 
	 * @param probs
	 *            A map of kmers of identical length and their probabilities,
	 *            which must sum to 1.
	 */
	public void setKmerFrequencies(Map<String, Double> probs) {
		// check that the specified probabilties sum to 1 and are for kmers of
		// the
		// correct length
		double total = 0.0;
	 ...
	 *      equal frequencies for all the kmer lengths
	 */
	...
	/**
	 * @see BackgroundModelFrequencySupport For a frequency based model this is
	 *      accomplished by setting reverse complements to have the average of
	 *      their frequencies, so there is no harm in running this method even
	 *      if the model is already destranded.
	 */
