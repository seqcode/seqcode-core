...
/**
 * <code>DatabaseConnectionManager</code> is the class that all code should use
 * to obtain database connections. Provides database connections for *roles* and
 * uses Tomcat JDBC to manage a connection pool. A role is a database resource
 * that you want to access, eg, <b>ucsc_mm9</b> for annotations for mm9 or
 * <b>core</b> for the core db.
 *
 * @author Shaun Mahony
 * @version 1.0
 */
