...
/**
 * @author tdanford Represents an entry in the core.exptcondition table. This is
 *         used as metadata for sequencing experiments. The name might describe
 *         cell stage like "ES" or a compact identifier of experimental
...
public class ExptCondition implements Comparable<ExptCondition> {
	...
	public int compareTo(ExptCondition c) {
