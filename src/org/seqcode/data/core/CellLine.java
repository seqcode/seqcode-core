 ...
 * @author tdanford
 *
 *         Represents an entry in the core.cellline table. This is used as
 *         metadata for sequencing experiments. The name might be something
 *         general (and not very useful) like 'S288C' or a cell line name or
 *         strain number.
 */
public class CellLine implements Comparable<CellLine> {
	...
	/**
	 * Creates a new <code>CellLine</code> object from a ResultSet that is set
	...
	public int compareTo(CellLine c) {
