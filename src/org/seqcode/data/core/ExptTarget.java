...
/**
 * @author tdanford Represents an entry in the core.expttarget table. This is
 *         used as metadata for sequencing experiments. The name might describe
 *         describe the target of the antibody in ChIP-seq experiments, or the
 *         type of RNA targeted by RNA-seq experiments.
 */
public class ExptTarget implements Comparable<ExptTarget> {
	...
	public int compareTo(ExptTarget f) {
