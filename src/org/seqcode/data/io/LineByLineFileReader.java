...
public class LineByLineFileReader {
	...
	/**
	 * Read the next line that isn't a comment, as indicated by starting with
	 * one of the specified prefixes
	 *
	 * @param commentPrefixes
	 *            prefixes indicating a comment line
	...
	/**
	 * Read an entire file in one pass and return an array of lines No lines are
	 * treated as comments
	 * 
	 * @param filename
	 ...
	 *            indicates whether or not to ignore blank lines
	 * @return
	 * @throws IOException
	 */
	public static String[] readFile(String filename, String[] commentPrefixes, boolean ignoreBlankLines)
			throws IOException {
