...
public class GFFEntry {
	...
	public boolean hasComplexAttrib(String key) {
		return fComplexAttribs.containsKey(key);
	}
	...
	public boolean equals(Object o) {
		...
		if (!fChr.equals(l.fChr)) {
			return false;
		}
		if (!fSource.equals(l.fSource)) {
			return false;
		}
		if (!fFeature.equals(l.fFeature)) {
			return false;
		}
		if (fStart != l.fStart || fEnd != l.fEnd) {
			return false;
		}
		if (fStrand != l.fStrand) {
			return false;
		}
		if (!fFrame.equals(l.fFrame)) {
			return false;
		}
		if (fScore != l.fScore) {
			return false;
		}
		if (fSimpleAttribs.size() != l.fSimpleAttribs.size()) {
			return false;
		}
		if (fComplexAttribs.keySet().size() != l.fComplexAttribs.keySet().size()) {
			return false;
		}
		Iterator itr = fSimpleAttribs.iterator();
		while (itr.hasNext()) {
			String key = (String) itr.next();
			if (!l.fSimpleAttribs.contains(key)) {
				return false;
			}
		}
		...
		while (itr.hasNext()) {
			String key = (String) itr.next();
			if (!l.fComplexAttribs.containsKey(key)) {
				return false;
			}
	...
	public String getAttrib(String v) {
		if (!fComplexAttribs.containsKey(v)) {
			return null;
		}
