 ...
 * @author tdanford
 *
 *         <code>FASTAStream</code> is an iterator over the sequences in a FASTA
 *         file. Each sequence is returned as a Pair of Strings: the first
 *         String is the name of the sequence and the second String is the
 *         sequence itself.
 */
