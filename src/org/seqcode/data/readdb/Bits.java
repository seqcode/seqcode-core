...
/**
 * Utility methods for reading and writing floats and ints and such in binary
 * form to and from Input and Output Streams.
 *
 */
...
public class Bits {
	...
	/**
	 * Sends the count bytes starting at offset from the ByteBuffer to the
	 * channel
	 */
	...
	/**
	 * sends the specified integers to the specified output stream. uses the
	 * current value of the order field to determine whether it should send big
	 * or little endian.
	 *
