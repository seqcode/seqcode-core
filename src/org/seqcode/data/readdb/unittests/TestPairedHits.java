...
public class TestPairedHits {
	...
	public TestPairedHits() throws IOException {
		...
		for (int i = 0; i < len; i++) {
			hits.add(new PairedHit(isLeft ? chrom : (int) (Math.random() * 1000), (int) (Math.random() * 100000000),
					i % 3 == 1, (short) (Math.random() * 100 + 1), isLeft ? (int) (Math.random() * 1000) : chrom,
					(int) (Math.random() * 100000000), i % 3 == 1, (short) (Math.random() * 100 + 1),
	...
	public void testArraySort() {
		...
		for (int i = 0; i < 1000; i++) {
			ph.add(new PairedHit(chrom, (int) (Math.random() * 100000000), i % 3 == 1,
					(short) (Math.random() * 100 + 1), chrom, (int) (Math.random() * 100000000), i % 3 == 1,
					(short) (Math.random() * 100 + 1), (float) Math.random(), i % 3));
		}
	...
	public void testStrand() {
		...
		for (int i = 0; i < hits.size(); i++) {
			assertEquals(!hitsfile.isLeft() ? hits.get(i).rightStrand : hits.get(i).leftStrand,
	...
	public void testLength() {
		IntBP las = hitsfile.getLASBuffer();
		for (int i = 0; i < hits.size(); i++) {
			assertEquals(!hitsfile.isLeft() ? hits.get(i).rightLength : hits.get(i).leftLength,
	...
	public void testAppend() throws IOException {
		...
		int len = 1000;
		for (int i = 0; i < len; i++) {
			orighits.add(new PairedHit(isLeft ? chrom : (int) (Math.random() * 1000), (int) (Math.random() * 100000000),
					i % 3 == 1, (short) (Math.random() * 100 + 1), isLeft ? (int) (Math.random() * 1000) : chrom,
					(int) (Math.random() * 100000000), i % 3 == 1, (short) (Math.random() * 100 + 1),
					(float) Math.random(), i % 3));
		}
		for (int i = 0; i < len; i++) {
			newhits.add(new PairedHit(isLeft ? chrom : (int) (Math.random() * 1000), (int) (Math.random() * 100000000),
					i % 3 == 1, (short) (Math.random() * 100 + 1), isLeft ? (int) (Math.random() * 1000) : chrom,
					(int) (Math.random() * 100000000), i % 3 == 1, (short) (Math.random() * 100 + 1),
					(float) Math.random(), i % 3));
		}
		...
		for (int i = 0; i < allhits.size(); i++) {
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).leftChrom,
					isLeft ? chrom : otherchrom.get(i));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).leftPos,
					isLeft ? positions.get(i) : otherpos.get(i));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).leftStrand,
					isLeft ? Hits.getStrandOne(las.get(i)) : Hits.getStrandTwo(las.get(i)));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).leftLength,
					isLeft ? Hits.getLengthOne(las.get(i)) : Hits.getLengthTwo(las.get(i)));

			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).rightChrom,
					!isLeft ? chrom : otherchrom.get(i));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).rightPos,
					!isLeft ? positions.get(i) : otherpos.get(i));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).rightStrand,
					!isLeft ? Hits.getStrandOne(las.get(i)) : Hits.getStrandTwo(las.get(i)));
			assertEquals(String.format("Hit %d, %s", i, allhits.get(i)), allhits.get(i).rightLength,
					!isLeft ? Hits.getLengthOne(las.get(i)) : Hits.getLengthTwo(las.get(i)));
