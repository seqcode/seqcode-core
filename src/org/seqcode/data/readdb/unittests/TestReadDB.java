...
/**
 * Regression tests for readb. Uses the Client class to communicate with a
 * server (should be newly initialized) You need to have a server setup with two
 * accounts.
 */
...
public class TestReadDB {
	...
	public void storeSortedSingle() throws IOException, ClientException {
		...
		assertEquals(name + " chrom 1 has 4 hits (either strand)",
				c.getCount(name, 1, false, false, null, null, null, null, null), 4);
		assertEquals(name + " chrom 10 has 4 hits (either strand)",
				c.getCount(name, 10, false, false, null, null, null, null, null), 3);
		assertEquals(name + " chrom 1 has 4 hits (+ strand)",
				c.getCount(name, 1, false, false, null, null, null, null, true), 4);
		assertEquals(name + " chrom 10 has 4 hits (+ strand)",
				c.getCount(name, 10, false, false, null, null, null, null, true), 2);
		assertEquals(name + " chrom 1 has 0 hits (- strand)",
				c.getCount(name, 1, false, false, null, null, null, null, false), 0);
		assertEquals(name + " chrom 10 has 1 hits (- strand)",
				c.getCount(name, 10, false, false, null, null, null, null, false), 1);
	...
	public void storeDouble() throws IOException, ClientException {
		...
		assertEquals(name + " chrom 1 has 8 hits (either strand)",
				c.getCount(name, 1, false, false, null, null, null, null, null), 4);
		assertEquals(name + " chrom 10 has 6 hits (either strand)",
				c.getCount(name, 10, false, false, null, null, null, null, null), 3);
		assertEquals(name + " chrom 1 has 8 hits (+ strand)",
				c.getCount(name, 1, false, false, null, null, null, null, true), 4);
		assertEquals(name + " chrom 10 has 4 hits (+ strand)",
				c.getCount(name, 10, false, false, null, null, null, null, true), 2);
		assertEquals(name + " chrom 1 has 0 hits (- strand)",
				c.getCount(name, 1, false, false, null, null, null, null, false), 0);
		assertEquals(name + " chrom 10 has 2 hits (- strand)",
				c.getCount(name, 10, false, false, null, null, null, null, false), 1);
		...
		assertEquals(name + " chrom 1 has 8 hits (either strand)",
				c.getCount(name, 1, false, false, null, null, null, null, null), 8);
		assertEquals(name + " chrom 10 has 6 hits (either strand)",
				c.getCount(name, 10, false, false, null, null, null, null, null), 6);
		assertEquals(name + " chrom 1 has 8 hits (+ strand)",
				c.getCount(name, 1, false, false, null, null, null, null, true), 8);
		assertEquals(name + " chrom 10 has 4 hits (+ strand)",
				c.getCount(name, 10, false, false, null, null, null, null, true), 4);
		assertEquals(name + " chrom 1 has 0 hits (- strand)",
				c.getCount(name, 1, false, false, null, null, null, null, false), 0);
		assertEquals(name + " chrom 10 has 2 hits (- strand)",
				c.getCount(name, 10, false, false, null, null, null, null, false), 2);
	...
	@Test
	public void storeUnsortedSingleType2() throws IOException, ClientException {
		Client c = new Client(hostname, portnum, user, passwd);
		...
		assertEquals(name + " chrom 1 has 4 hits (either strand)",
				c.getCount(name, 1, true, false, null, null, null, null, null), 4);
		assertEquals(name + " chrom 10 has 4 hits (either strand)",
				c.getCount(name, 10, true, false, null, null, null, null, null), 3);
		assertEquals(name + " chrom 1 has 4 hits (+ strand)",
				c.getCount(name, 1, true, false, null, null, null, null, true), 4);
		assertEquals(name + " chrom 10 has 4 hits (+ strand)",
				c.getCount(name, 10, true, false, null, null, null, null, true), 2);
		assertEquals(name + " chrom 1 has 0 hits (- strand)",
				c.getCount(name, 1, true, false, null, null, null, null, false), 0);
		assertEquals(name + " chrom 10 has 1 hits (- strand)",
				c.getCount(name, 10, true, false, null, null, null, null, false), 1);
	...
	public void testRangeQuery() throws IOException, ClientException {
		...
		for (int q = 0; q < 30; q++) {
			...
			assertTrue(
					String.format("%s %d != %d", name, count,
							c.getCount(name, chrom, false, false, start, end, null, null, null)),
					count == c.getCount(name, chrom, false, false, start, end, null, null, null));
			int back[] = c.getPositions(name, chrom, false, false, start, end, null, null, null);
			int j = 0;
			int k = 0;
			while (j < hits.size() && hits.get(j).pos < start) {
				j++;
			}
	...
	public void testHistogram2() throws IOException, ClientException {
		...
		for (int q = 0; q < 10; q++) {
			...
			for (int i = 0; i < MAXVALUE; i++) {
				hits.add(new SingleHit(chrom, (int) Math.round(Math.random() * MAXVALUE),
						(float) (Math.random() * MAXWEIGHT), false, 10));
			}
			c.storeSingle(name, hits, false);
			Collections.sort(hits);
			...
			for (int q2 = 0; q2 < 10; q2++) {
				...
				Map<Integer, Integer> plainhist = c.getHistogram(name, chrom, false, false, 0, binsize, start, end,
						null, null);
				Map<Integer, Integer> minweighthist = c.getHistogram(name, chrom, false, false, 0, binsize, start, end,
						weight, null);
				Map<Integer, Float> weighthist = c.getWeightHistogram(name, chrom, false, false, 0, binsize, start, end,
						null, null);
				Map<Integer, Float> minwwhist = c.getWeightHistogram(name, chrom, false, false, 0, binsize, start, end,
						weight, null);
	...
	@Test
	public void testHistogramType2() throws IOException, ClientException {
		Client c = new Client(hostname, portnum, user, passwd);
	...
	public void testMaximumStore() throws IOException, ClientException {
		...
		for (int n = 100000; n <= 50000000; n *= 2) {
			...
			ArrayList<SingleHit> hits = new ArrayList<SingleHit>();
			for (int i = 0; i < n; i++) {
				hits.add(new SingleHit(50, i, 1.0F, true, 10));
			}
			c.storeSingle(name, hits, false);
			assertEquals(name + " numhits unstranded",
					c.getCount(name, 50, false, false, null, null, null, false, null), n);
			assertEquals(name + " numhits +", c.getCount(name, 50, false, false, null, null, null, false, true), n);
			assertEquals(name + " numhits -", c.getCount(name, 50, false, false, null, null, null, false, false), 0);
	...
	public void testPairedReads() throws IOException, ClientException {
		...
		for (int i = 0; i < 1000; i++) {
			hits.add(new PairedHit(i % 4, i, i % 3 != 1, (short) (Math.random() * 100 + 1), (i % 4) + 255, i + 0xffff,
					i % 3 == 1, (short) (Math.random() * 100 + 1), (float) Math.random() * 10, i % 3));
		}
		Client c = new Client(hostname, portnum, user, passwd);
		...
		for (int chrom : map.keySet()) {
			...
			assertEquals(
					String.format("chrom %d, %d ?= %d", chrom, list.size(),
							c.getCount(name, chrom, false, true, null, null, null, true, null)),
	...
	public void testSecondStorePairedReads() throws IOException, ClientException {
		List<PairedHit> hits = new ArrayList<PairedHit>();
		for (int i = 0; i < 1000; i++) {
			hits.add(new PairedHit(i % 4, i, i % 3 != 1, (short) 10, (i % 4) + 255, i + 0xffff, i % 3 == 1, (short) 20,
					(float) Math.random(), i % 3));
		}
		Client c = new Client(hostname, portnum, user, passwd);
		...
		for (int i = 500; i < 2000; i++) {
			newhits.add(new PairedHit(i % 4, i, i % 3 != 1, (short) 30, (i % 4) + 255, i + 0xffff, i % 3 == 1,
					(short) 40, (float) Math.random(), i % 3));
		}
	...
	public void testDelete3() throws IOException, ClientException {
		...
		for (int i = 0; i < 1000; i++) {
			phits.add(new PairedHit(i % 4, i, i % 3 != 1, (short) (Math.random() * 100 + 1), (i % 4) + 255, i + 0xffff,
					i % 3 == 1, (short) (Math.random() * 100 + 1), (float) Math.random() * 10, i % 3));
		}
