...
/**
 * Represents a change to an ACL. operation (o) is either ADD or REMOVE and acl
 * (a) is either READ, WRITE, or ADMIN.
 */
public class ACLChangeEntry {
	...
	public String toString() {
		return String.format("%s %s %s", princ, ops[operation], acls[acl]);
	}
