...
public class Gaussian {
	 ...
	 * 
	 * @param value
	 *            the value whose z-score will be calculated
	 ...
	 * 
	 * @param value
	 *            the value whose likelihood will be calculated
	 ...
	 * 
	 * @param value
	 *            the value whose log-likelihood will be calculated
	 ...
	 * 
	 * @param value
	 *            the last value of a set of <tt>n</tt> data points whose (the
	 *            set) total log-likelihood will be calculated
	 * @param n
	 *            # of data points
	 * @param prevMean
	 *            previous mean (of <tt>n-1</tt> data points)
	 * @param prevVar
	 *            previous variance (of <tt>n-1</tt> data points)
	...
	public double dynCalcTotalLogProbability(Double value, int n, Double prevMean, Double prevVar) {
		return -((double) n / 2) * Math.log(2.0 * Math.PI * variance) - (1 / (2.0 * variance))
				* ((n - 1) * (prevVar + (mean - prevMean) * (mean - prevMean)) + (value - mean) * (value - mean));
	 ...
	 * 
	 * @param value
	 *            value the value whose z-score will be calculated
	 * @param mean
	 *            mean
	 * @param var
	 *            variance
	 ...
	 *            # of data points
	 * @param mean
	 *            current mean (of <tt>n</tt> data points)
	 * @param var
	 *            current variance (of <tt>n</tt> data points)
	 * @param prevMean
	 *            previous mean (of <tt>n-1</tt> data points)
	 * @param prevVar
	 *            previous variance (of <tt>n-1</tt> data points)
	 * @return the likelihood of the set of <tt>n</tt> data points
	 */
	public static double dynCalcTotalProbability(Double value, int n, Double mean, Double var, Double prevMean,
			Double prevVar) {
	 ...
	 * @return the log-likelihood of the set of <tt>n</tt> data points
	 */
	public static double dynCalcTotalLogProbability(Double value, int n, Double mean, Double var, Double prevMean,
			Double prevVar) {
		return -((double) n / 2) * Math.log(2.0 * Math.PI * var) - (1 / (2.0 * var))
				* ((n - 1) * (prevVar + (mean - prevMean) * (mean - prevMean)) + (value - mean) * (value - mean));
