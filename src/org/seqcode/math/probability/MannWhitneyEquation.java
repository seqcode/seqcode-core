 ...
 *         of Mathematical Statistics. Vol. 18, No. 1. (March 1947), pp.50-60.
 * 
 *         URL:
 *         http://links.jstor.org/sici?sici=0003-4851%28194703%2918%3A1%3C50%3AOATOWO%3E2.0.CO%3B2-M
 * 
 */
public class MannWhitneyEquation implements RecurrenceEquation {
	 ...
	 * 
	 * @see
	 * edu.mit.csail.psrg.utils.RecurrenceEquation#getValue(edu.mit.csail.psrg.
	 * utils.RecurrenceEquation.Arguments)
	 */
	public double getValue(Arguments a) {
		 ...
		 * System.out.print(" = "); System.out.print("(" + n + "/" + (n+m) +
		 * ") * "); System.out.print(leftValue); System.out.print(" + (" + m +
		 * "/" + (n+m) + ") * "); System.out.print(rightValue);
	...
	public void printCache(PrintStream p) {
		for (Arguments a : cache.keySet()) {
			p.println(a.getArgument(0) + "\t" + a.getArgument(1) + "\t" + a.getArgument(2) + "\t" + cache.get(a));
		}
	}
