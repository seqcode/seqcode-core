...
public class InfoTheoryUtil {
	...
	// zeros are treated specially (essentially as missing values) - only
	// entries for which
	// one sequence has non-zero entries are considered
	public static double discreteMutualInformationOverlap(int[] sequenceX, int[] sequenceY, int[] pX, int[] pY,
			int[][] pXY) {
		double v = 0.0;
		double vt = 0.0;
		int i = 0;
