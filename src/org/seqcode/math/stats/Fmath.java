...
public class Fmath {
	...
	public static final double H_PLANCK_RED = H_PLANCK
			/ (2 * Math.PI); /* J s */
	...
	// Angle (in radians) between sides sideA and sideB given all side lengths
	// of a triangle
	...
	// Tangent of angle between sides sideA and sideB given all side lengths of
	// a triangle
	...
	// DEPRECATED METHODS
	// Several methods have been revised and moved to classes ArrayMaths, Conv
	// or PrintToScreen
	...
	// MAXIMUM DISTANCE BETWEEN ARRAY ELEMENTS (deprecated - see ArryMaths
	// class)
	...
	// MINIMUM DISTANCE BETWEEN ARRAY ELEMENTS (deprecated - see ArryMaths
	// class)
	...
	// sort the elements of an array of floats into ascending order with
	// matching switches in an array of the length
	// using selection sort method
	// array determining the order is the first argument
	// matching array is the second argument
	...
	// sort elements in an array of doubles (first argument) into ascending
	// order
	// using selection sort method
