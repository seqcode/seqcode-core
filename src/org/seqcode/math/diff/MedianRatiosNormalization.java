...
/**
 * MedianRatiosNormalization: a Normalization class that implements the median
 * of ratios normalization as proposed by Anders & Huber, Genome Biology, 2010
 * 
 * @author Shaun Mahony
 * @version %I%, %G%
 */
public class MedianRatiosNormalization extends Normalization {
	 ...
	 * values to trim, and the fraction of extreme A values to trim
	 * 
	 * @param numSamples
	 * @param Mtrim
	 * @param Atrim
