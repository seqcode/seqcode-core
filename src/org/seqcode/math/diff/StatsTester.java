...
public class StatsTester {
	 ...
	 * @param focalCond
	 */
	public StatsTester(EventsConfig econ, String dataFile, String normMethod, String diffMethod, int focalCond,
			File outDir, String outBase) {
		config = econ;
		...
		if (diffMethod.equals("EDGER")) {
			DifferentialEnrichment EdgeR = new EdgeRDifferentialEnrichment(config, outDir, outBase);
