...
/**
 * DifferentialEnrichment: parent class for testers of pairwise differential
 * enrichment in count data
 * 
 * @author Shaun Mahony
 * @version %I%, %G%
 */
public abstract class DifferentialEnrichment {
	...
	/**
	 * All DifferentialEnrichment implementations require an execute methods
	 * that will take a CountsDataset, process it for differential enrichment,
	 * and return a modified CountsDataset.
	 * 
	 * @param data
	 *            : CountsDataset
	 */
	...
	public void saveMeanVarPlot(Matrix xy, double[] yfit, String conditionName, boolean rasterImage) {
		...
		// Sub-sample fit-line and add (assuming xy is sorted, and yfit is
		// coordinate matched with xy)
		Matrix fitxy;
	...
	/**
	 * Set a file name identifier for the scripts that are produced by the
	 * differential enrichment implementation
	 */
	public void setFileIDname(String fid) {
		fileIDname = fid;
	}
}
