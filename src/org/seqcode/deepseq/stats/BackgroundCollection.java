...
/**
 * BackgroundCollection: A container to hold diverse types of BackgroundModel
 * and handle the various ways we may use them
 * 
 * @author Shaun Mahony
 * @version %I%, %G%
 */
public class BackgroundCollection {
	...
	public void addBackgroundModel(BackgroundModel m) {
		models.add(m);
	}
	 ...
	 */
	public void updateModels(Region currReg, int currOffset, float[] thisExptHitCounts, float[] otherExptHitCounts,
			float hitCountBin) {
		for (BackgroundModel m : models)
	 ...
	 * @return
	 */
	public boolean passesAllThresholds(int count) {
		return passesAllThresholds(count, '.');
	}
	...
	public boolean passesGenomicThreshold(int count) {
		return passesGenomicThreshold(count, '.');
	}
	 ...
	 * @return
	 */
	public boolean underAllThresholds(int count) {
		return underAllThresholds(count, '.');
	}
	...
	public boolean underGenomicThreshold(int count) {
		return underGenomicThreshold(count, '.');
	}
