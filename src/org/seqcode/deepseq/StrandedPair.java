...
/**
 * StrandedPair represents a pair of reads that are paired together. Coordinate
 * is the 5' end of each hit. Weight is determined by implementation of hit
 * loading.
 * 
 * @author mahony
 *
...
public class StrandedPair implements Comparable<StrandedPair> {
	...
	/**
	 * Returns distance between read 5' positions if this is a proper concurrent
	 * pair. Returns -1 otherwise.
	 * 
	 * @return
	 */
	public int getFragmentSize() {
		if (!sameChrom)
			return -1;
		else if ((r1Coordinate < r2Coordinate && r1Strand == '+' && r2Strand == '-')
				|| (r2Coordinate < r1Coordinate && r2Strand == '+' && r1Strand == '-')) {
	...
	public boolean pairFromSameChrom() {
		return sameChrom;
	}
	...
	public String toString() {
		return new String(gen.getChromName(r1Chrom) + ":" + r1Coordinate + ":" + r1Strand + "\t"
				+ gen.getChromName(r2Chrom) + ":" + r2Coordinate + ":" + r2Strand + "\t" + weight);
	}
