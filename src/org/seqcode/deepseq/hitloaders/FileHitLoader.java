...
/**
 * FileHitLoader: Loads reads from a collection of files. Formats supported:
...
public abstract class FileHitLoader extends HitLoader {
	 ...
	 *            String
	 * @param files
	 *            Pairs of Files and Strings (formats)
	 * @param useNonUnique
	 *            boolean -- load non-uniquely mapping reads
	 */
	public FileHitLoader(File file, boolean useNonUnique, boolean loadT1, boolean loadT2, boolean loadRead2,
			boolean loadPairs) {
