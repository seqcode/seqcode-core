...
/**
 * CountDataSimulator: generate a two-condition CountsDataset file given an
 * empirically observed dataset and some parameters
 * 
 * @author Shaun Mahony
 * @version %I%, %G%
 */
public class CountDataSimulator {
	...
	private Double alpha = 0.15; // Parameter for biological variance. Poisson
									// distribution (technical variance only) is
									// alpha=0
	private Double upRegFrac = 0.1; // Fraction of genes that are up-regulated B
									// vs A
	private Double downRegFrac = 0.1; // Fraction of genes that are
										// down-regulated B vs A
	private Double diffExpLevel = 2.0; // Base fold-change of differentially
										// regulated genes
	...
	// Modifiers
	public void setDataPoints(int nd) {
		numDataPoints = nd;
	}
	...
	public void setReplicates(int r) {
		numReplicates = r;
	}
	...
	public void setReads(Double r) {
		condATotalReads = r;
		condBTotalReads = r;
	}

	public void setReadsA(Double r) {
		condATotalReads = r;
	}

	public void setReadsB(Double r) {
		condBTotalReads = r;
	}

	public void setUpRegFrac(Double f) {
		upRegFrac = f;
	}

	public void setDownRegFrac(Double f) {
		downRegFrac = f;
	}

	public void setDiffExpLevel(Double d) {
		diffExpLevel = d;
	}
	...
	public List<SimCounts> simulate() {
		...
		for (int d = 0; d < numDataPoints; d++) {
			...
			// Is this gene differentially expressed in this condition? (w.r.t
			// condition A)
	...
	public class SimCounts {
		public double absolute; // The absolute value of binding enrichment
								// (mean before differential)
		public double[] counts; // The simulated counts
		public double[] backup; // Extra counts used by the multi-condition read
								// simulator
