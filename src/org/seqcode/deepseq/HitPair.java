...
/**
 * Mini class to hold four bits of information on the hit pair: (assumes that R1
 * hit chromosome and strand are stored in the data structure itself - R1 hit 5'
 * pos - R2 hit chr - R2 hit 5' pos - R2 hit strand
 * 
 * @author mahony
 */
