...
public class StrandedBaseCountFilterByBase {
	...
	int baseRelPosition; // Position base is reqd to appear at, wrt the five
							// prime position of the SBC.
	...
	/**
	 * This method filters an input list of StrandedBaseCounts by the base rules
	 * defined in the constructor. Assumes that the input list of reads is
	 * defined by a single Region on the genome.
	 * 
	 * @param currentReg
	 * @param reads
	 * @return
