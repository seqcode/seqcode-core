...
public class GenomeSelectPanel extends JPanel implements EventSource<ActionEvent> {
	...
	private void populateSpecies() {
		...
		if (sel != null) {
			speciesModel.setSelectedItem(sel);
		}
		populateGenome();
	}
	...
	private void populateGenome() {
		try {
			...
			if (sel != null) {
				genomeModel.setSelectedItem(sel);
			}
	...
	public String getSpecies() {
		return (String) speciesModel.getSelectedItem();
	}

	public String getGenome() {
		return (String) genomeModel.getSelectedItem();
	}
...
class ActionListenerWrapper implements Listener<ActionEvent> {
	...
	public boolean equals(Object o) {
		if (!(o instanceof ActionListenerWrapper)) {
			return false;
		}
