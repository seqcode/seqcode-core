...
/**
 * ProfilePaintable wraps a Profile object, and paints it in a window region in
 * the simplest possible way (connected lines between points).
 * 
...
public class ProfilePaintable extends AbstractPaintable {
	...
	public void setDrawPointMarkers(boolean drawMarkers) {
		drawPointMarkers = drawMarkers;
	}
