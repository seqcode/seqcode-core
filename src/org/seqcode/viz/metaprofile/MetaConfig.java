...
public class MetaConfig {
	...
	public char baseLimit = '.'; // Only draw meta-plots for tags with this
									// character at baseLimitRelPosition
									// relative to 5' end (. = draw all tags)
