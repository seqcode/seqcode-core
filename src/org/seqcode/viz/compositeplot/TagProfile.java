...
public class TagProfile {
	...
	protected int center; // The index at the center of the profile (rel coord =
							// 0)
	protected int width;
	 ...
	 * @param watson
	 * @param crick
	 *            : if null, this is an unstranded tag density
	 * @param centerBin
	 */
	...
	// Accessors
	public double[] getWatsonTags() {
		return watsonTags;
	}

	public double[] getCrickTags() {
		return crickTags;
	}
	...
	public int getLeftRelCoord() {
		return -center;
	}

	public int getRightRelCoord() {
		return (width - center - 1);
	}
	...
	public double getWatsonTagsAtRelCoord(int coord) {
		return watsonTags[getBinAtRelCoord(coord)];
	}

	public double getCrickTagsAtRelCoord(int coord) {
		return crickTags[getBinAtRelCoord(coord)];
	}
