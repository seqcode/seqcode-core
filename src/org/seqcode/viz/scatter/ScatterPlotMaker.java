...
/**
 * ScatterPlotterConfigured: Extension of ScatterPlot that implements a number
 * of purpose-specific configurations as methods.
 * 
 * @author Shaun Mahony
 * @version %I%, %G%
 */
public class ScatterPlotMaker extends ScatterPlot {
	...
	/**
	 * Make an MA plot from one or two 2-D datasets (one will be highlighted in
	 * a different color) and save image. This configuration is used by
	 * deepseq.stats.Normalization classes
	 * 
	 * @param datapoints
	 ...
	 * @param yLine
	 *            Double - data coordinates of line to be drawn parallel to x
	 *            axis (used to show scaling line)
	 * @param outFilename
	 *            - String
	 * @param rasterImage
	 *            - boolean
	 */
	public void saveMAplot(Matrix datapoints, Matrix datapoints_highlight, Double yLine, String outFilename,
			boolean rasterImage) {
		this.setWidth(800);
		this.setHeight(800);
		...
		if (yLine != null) {
			XYLineAnnotation lineAnnot = new XYLineAnnotation(xLower, yLine, xUpper, yLine, new BasicStroke(1),
					new Color(0, 0, 0));
	...
	/**
	 * Make an XY scatter plot from one or two 2-D datasets (one will be
	 * highlighted in a different color) and save image. This configuration is
	 * used by deepseq.stats.Normalization classes
	 * 
	 * @param datapoints
	 *            - 2D dataset (colored grey)
	 * @param datapoints_highlight
	 ...
	 *            - boolean
	 */
	public void saveXYplot(Matrix datapoints, Matrix datapoints_highlight, String xName, String yName,
