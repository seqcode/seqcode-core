...
public class GraphView extends ObjectView {
	...
	public void setDefaultNodeOption(String k, Object v) {
		defaultNodeOptions.setOption(k, v);
	}

	public void setDefaultEdgeOption(String k, Object v) {
		defaultEdgeOptions.setOption(k, v);
	}
