 ...
 * @author tdanford
 *
 *         Wraps the GraphView object, and turns it into a Paintable
 *         implementation.
 * 
 *         This is the actual class which contains all the code to turn every
 *         option stored in an ObjectView of some kind, into graphical features.
 */
