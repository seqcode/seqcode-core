...
import org.seqcode.viz.utils.TextLayout;
...
public class TextView extends NodeView {
	...
	public void paintView(Graphics2D g2) {
		...
		if (containsOption("paragraph")) {
			...
			Font f = containsOption("font") ? (Font) options.get("font") : new Font("Arial", Font.PLAIN, 12);
			g2.setFont(f);

			TextLayout layout = new TextLayout();
			int lineLength = containsOption("line-length") ? (Integer) options.get("line-length") : 40;
