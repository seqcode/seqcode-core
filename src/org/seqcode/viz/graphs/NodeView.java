...
public class NodeView extends ObjectView {
	...
	public boolean containsName() {
		return containsOption("contains-name") && (Boolean) options.get("contains-name") == true;
	}
	...
	public String getTimeMark() {
		return (String) options.get("timemark");
	}

	public void setTimeMark(String n) {
		options.put("timemark", n);
	}
