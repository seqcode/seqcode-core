...
public class ScatterPlot extends AbstractPaintable implements PaintableScaleListener {
	...
	/**
	 * A general-purpose method to set up a ScatterPlot as well as a vertical
	 * and horizontal scale painter.
	 * 
	 * @param pts
	 * @return
	 */
	...
	/**
	 * Same as above, except that the ScatterPlot display is to share the same
	 * x- and y-scales.
	 * 
	 * @param pts
	 * @return
	...
	/**
	 * Generates a set of random points, linearly related to each other, for
	 * testing purposes.
	 * 
	 * @param rand
	 * @param count
	...
	/**
	 * Uses the findPoints() reflective method below, but with the default
	 * parameters for the fields names of "x" and "y".
	 * 
	 * @param models
	 * @return
	 */
	...
	/**
	 * Uses reflection to pick through a list of objects, and pulls out the
	 * values under the two given field names concatenates them as a double[]
	 * array (a point), and returns a list of them. Ignores any non-Double or
	 * inaccessible fields.
	 * 
	 * @param models
	 * @param xName
	...
	/**
	 * Turns a pair of arrays into a collection of pairs. Used in the
	 * constructor to ScatterPlot, below.
	 * 
	 * @param x
	 * @param y
	 * @return
