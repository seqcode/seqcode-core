...
public class LayeredPaintable extends AbstractPaintable {
	...
	/*
	 * public Collection<Action> getPaintableActions() { LinkedList<Action> lst
	 * = new LinkedList<Action>(); for(Paintable p : fLayers) {
	 * lst.addAll(p.getPaintableActions()); } return lst; }
	 */
}
