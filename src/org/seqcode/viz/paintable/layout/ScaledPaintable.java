...
public class ScaledPaintable extends AbstractPaintable {
	...
	public ScaledPaintable(Paintable p, double x, double y, double w, double h) {
		super();
		fBase = p;
		fXFrac = new Double(x);
		fYFrac = new Double(y);
	...
	public double getXFrac() {
		return fXFrac.doubleValue();
	}

	public double getYFrac() {
		return fYFrac.doubleValue();
	}

	public double getWidthFrac() {
		return fWidthFrac.doubleValue();
	}

	public double getHeightFrac() {
		return fHeightFrac.doubleValue();
	}
