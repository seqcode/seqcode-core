...
public abstract class AbstractModelPaintable extends AbstractPaintable
		implements ModelPaintable, ModelPaintablePropertyListener {
	...
	public void addValue(Object v) {
		if (v instanceof Model) {
			...
			throw new IllegalArgumentException(
					String.format("Unsupported value type: %s", v.getClass().getSimpleName()));
		}
	}
