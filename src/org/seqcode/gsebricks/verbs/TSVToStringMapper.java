...
/**
 * <code>TSVToStringMapper</code> tries to hide (or at least put all the messy
 * parts in one place) the complexity of mapping objects to tab-separated-values
 * as one might want for file output. This works by having a hardcoded list of
 * classes and a block of code to output each.
 */
