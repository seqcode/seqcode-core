...
public interface Annotations<Item, Annotation> {
	...
	/*
	 * returns true iff the item has any annotations provided by the annotator
	 * specified by key
	 */
	public boolean isAnnotated(Item target, String key);

	/*
	 * returns a bit vector (as a string) showing whether the item is annotated
	 * by each annotator. The order of the annotators is that specified by
	 * getAnnotationKeyOrder
	 */
	...
	/*
	 * returns all annotations for this item that were provided by the specified
	 * annotator
	 */
	...
	/*
	 * adds a new annotator to this set of annotations. Generates annotations
	 * for all previously added items
	 */
