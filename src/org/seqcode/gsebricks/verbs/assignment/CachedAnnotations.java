...
public class CachedAnnotations<Item, Annotation> implements Annotations<Item, Annotation> {
	...
	/*
	 * called every time an item is annotated. Subclasses can use this to
	 * display a measure of progress of the annotation
	 */
