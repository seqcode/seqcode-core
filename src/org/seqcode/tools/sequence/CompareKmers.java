 ...
 *
 * java org.seqcode.genome.sequence.CompareKmers --k 6 --one foo.fasta --two
 * bar.fasta
 *
 */
...
public class CompareKmers {
	...
	public void report() {
		...
		System.out.println(
				String.format("chi-squared value is %f with %d DOF.  CDF is %f", stat, n - 1, csquare.cdf(stat)));
		System.out.println(
				String.format("There were %d below 5 and %d that were zero (%d observations)", toosmall, zero, inzero));
