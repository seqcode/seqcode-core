 ...
 * 
 * cat gene_names.txt | java GeneORFs --species "$SC;Sigmav7" --genes
 * s288cMapped cat gene_names.txt | java GeneORFs --species "$SC;Sigmav7"
 * --genes s288cMapped --fasta java GeneORFs --species "$SC;Sigmav7" --genes
 * s288cMapped --fasta --allgenes
 *
 *
 */
