...
/**
 * reads a list of stranded regions (one per line) on STDIN. Produces on stdout
 * a fasta file containing those regions. The genome is specified on the command
 * line as --species "Mus musculus;mm8"
 */
