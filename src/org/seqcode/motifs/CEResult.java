...
public class CEResult {
	...
	public String toString() {
		return String.format("%2.1f\t%d\t%d\t%.2f\t%d\t%d\t%.2f\t%.2e\t%s\t%s\t%s\t%s", logfoldchange, countone,
				sizeone, freqone, counttwo, sizetwo, freqtwo, pval, matrix.name, matrix.version, percentString,
				cutoffString);
	}
}