...
/**
 * Generates a .png file with a set of motif logos in it. Needs --species and
 * --out (output file name) on the command line. Reads motifs on STDIN. Fields
 * are tab or semicolon separated and are name, version, and an optional
 * additional label
 *
 */
...
public class DrawMotifs {
	...
	public static void main(String args[]) throws Exception {
		...
		ClusterMotifs.drawCluster(matrices, outfilename, 800, 200, 2);
	...
	public static void printMotifLogo(WeightMatrix wm, File f, int pixheight, String label, boolean drawAxes) {
		int pixwidth = (pixheight - WeightMatrixPainter.Y_MARGIN * 3 - WeightMatrixPainter.YLABEL_SIZE) * wm.length()
				/ 2 + WeightMatrixPainter.X_MARGIN * 2;
	...
	public static void printMotifLogo(WeightMatrix wm, File f, int pixheight, String label) {
		printMotifLogo(wm, f, pixheight, label, false);
	}
