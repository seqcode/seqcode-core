...
public class FeatureStatistics {
	...
	/**
	 * Binomial CDF assuming scaled control. Uses COLT binomial test. Tests
	 * equality of signal & scaled control counts.
	 * 
	 * @param k
	 *            = scaled control
	 * @param n
	 ...
	 * @param minFoldChange
	 *            = minimun fold difference between signal & control
	 * @return
	 */
	 ...
	 * Benjamini-Hochberg procedure, enforcing monotonicity of p-value increases
	 * as defined in: Storey JD. A direct approach to false discovery rates.
	 * Journal of the Royal Statistical Society. 2002;64:479-498
	 * 
	 */
