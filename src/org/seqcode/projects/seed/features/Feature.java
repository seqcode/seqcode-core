...
/**
 * Feature: Any genomic feature that we wish to discover in a deep-sequencing
 * experiment.
 * 
 * @author mahony
 */
public abstract class Feature implements Comparable<Feature> {
	 ...
	 * @param r
	 */
	public void setCoords(Region r) {
		coords = r;
	}
	 ...
	 * 
	 * @param extension
	 *            : extends window by half of extension either site of window (0
	 *            provides sequence from feature coords only)
	 * @return
	 */
