...
public class LBFGS {
        ...
        private  int iter = 0, nfun = 0, point = 0, ispt = 0, iypt = 0,
         ...
         */
        public  void lb1(int[] iprint, int iter1, int nfun1, double gnorm1,
         ...
         */
        public  void daxpy(int n, double da, double[] dx, int ix0, int incx,
         ...
         * from the Fortran.
         */
         double ddot(int n, double[] dx, int ix0, int incx, double[] dy,
                        int iy0, int incy) {
                double result = 0;
         ...
         boolean badNum(double n) {
                return Double.isNaN(n) || Double.isInfinite(n);
        }

         double safeMult(double n1, double n2) {
                double result = n1 * n2;
                if (badNum(result)) {
                        if (n1 == 0 || n2 == 0) {
                                result = 0;
         ...
         double safeDiv(double n1, double n2) {
                double result = n1 / n2;
                if (badNum(result)) {
                        if (n1 == 0 && n2 == 0) {
                                result = 1;
