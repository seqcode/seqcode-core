...
import org.seqcode.projects.akshay.chexmix.analysis.LoadTags;
import org.seqcode.projects.akshay.chexmix.utils.*;


public class BindingLocation {

	/**
	 * seqpos and seqneg are Seq  (org.seqcode.projects.akshay.chexmix.datasets.Seq) objects that contain the "+" and the "-" strand sequences 
	 * for the given bindinglocation 
	 */
	public Seq seqpos;
	public Seq seqneg;
	/**
	 * vecpos and vecneg are Vec objects (org.seqcode.projects.akshay.chexmix.datasets.Vec) that contain the tags/reads in the "+" and "-" strands
	 */
	public Vec vecpos;
	public Vec vecneg;
	/**
	 ...
	 * @param range
	 * @param smoothsize
	 * @return (Returns a custom object(org.seqcode.projects.akshay.chexmix.datasets.CustomReturn). maxvec1 in the return object is the offset
