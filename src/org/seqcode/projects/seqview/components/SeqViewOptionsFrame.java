...
/**
 * Options frame that is driven by the SeqView class (rather than being the
 * driver class itself).
 * 
 * @author mahony
 *
...
public class SeqViewOptionsFrame extends JFrame implements ActionListener {
	...
	void exit_actionPerformed(ActionEvent e) {
		...
		if (dataWindowsOpen) {
			int confirmResult = JOptionPane.showConfirmDialog(this, "Are you sure you want to exit SeqView?",
