		...
		if (regionwidth < w) {
			...
			if (chars.length * fontsize < w) {
				...
				for (int i = 0; i < chars.length; i++) {
					...
					int x = getXPos(regionstart + i, regionstart, regionend, x1, x2);
				...
				for (int i = 0; i < chars.length; i++) {
					...
					int x = getXPos(regionstart + i, regionstart, regionend, x1, x2) + (i % 2);
				...
				for (int i = 0; i < chars.length; i++) {
					...
					int xleft = getXPos(regionstart + i, regionstart, regionend, x1, x2);
					int xright = getXPos(regionstart + i + 1, regionstart, regionend, x1, x2);
