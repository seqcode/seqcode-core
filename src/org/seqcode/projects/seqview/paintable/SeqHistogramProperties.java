...
public class SeqHistogramProperties extends ExperimentPaintableProperties {
	...
	public Color getUnstrandedColor() {
		return unstrandedColor;
	}

	public Color getMateArcColor() {
		return mateArcColor;
	}

	public Color getSplitReadArcColor() {
		return splitReadArcColor;
	}

	public int getDrawGaussianMaxWindow() {
		return drawGaussianMaxWindow;
	}
