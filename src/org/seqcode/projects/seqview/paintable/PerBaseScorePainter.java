...
public class PerBaseScorePainter<X extends Number> extends RegionPaintable {
	...
	public PerBaseScorePainter(RegionMapperModel<X[]> model, double minscore, double maxscore) {
		this.model = model;
	...
	public PerBaseScorePainter(RegionMapperModel<X[]> model, double minscore, double middlescore, double maxscore) {
		this.model = model;
		props = new PerBaseScoreProperties();
		props.MaxScore = maxscore;
		props.MinScore = minscore;
