...
public abstract class RegionPaintable extends SeqViewPaintable {
	...
	/*
	 * How much vertical space can this Paintable use? This is returned in
	 * pixels and basically assumes screen resolution. -1 means
	...
	// Despite the misleading name, this must be the same as getMaxVertSpace,
	// unless the latter = -1
	...
	/*
	 * Sets the genomic region that this Paintable will display. The Paintable
	 * should set canPaint() to false until it is ready to display.
	 */
	...
	/*
	 * utility functions to help RegionPainters calculate display coordinate.
	 * These take region or value boundaries (eg, chromosome starting and ending
	 * coordinate or maximum and minimum value) and the area into which the
	 * paintable is drawing and maps a specific coordinate or value to an X or Y
	 * value.
	 */
