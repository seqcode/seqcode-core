...
import org.seqcode.gse.utils.io.parsing.GFFEntry;
import org.seqcode.gse.utils.io.parsing.ParseGFF;
...
import org.seqcode.projects.multigps.stats.DifferentialEnrichment;
import org.seqcode.projects.multigps.stats.EdgeRDifferentialEnrichment;
...
public class SignificanceTester {
	...
	//Constructor
	public SignificanceTester(ExptConfig econ, MultiGPSConfig config, ExperimentManager manager, BindingManager bman, String gffFileName, int win, double q, double minfold, boolean rankByQ) {
		this.econfig = econ;
		this.config = config;
	...
	public static void main(String[] args){
		...
		if(config.helpWanted()){
			...
			SignificanceTester tester = new SignificanceTester(econ, config, manager, bman, siteFile, win, qThres, minFold, rankbyq); 
