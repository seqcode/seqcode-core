...
import org.seqcode.gseutils.EventSource.Default;
...
public class TaxonomyImpl<X> implements Taxonomy<X>, Saveable, Listener<TaxonomyEvent> {
	...
	public void save(DataOutputStream dos) throws IOException {
		dos.writeInt(elmts.size());
		dos.writeInt(subTaxa.size());
		for (X v : elmts) {
	...
	public Set<String> getAddrs() {
		return subTaxa.keySet();
	}

	public boolean hasAddr(String s) {
		return subTaxa.containsKey(s);
	}
