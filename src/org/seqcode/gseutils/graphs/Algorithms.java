...
public class Algorithms {
	...
	private void searchAllPaths(String v1, String v2, Set<String> searched, LinkedList<LinkedList<String>> allPaths) {
		...
		for (String n : next) {
			...
			for (LinkedList<String> path : nextPaths) {
				path.addFirst(v1);
			}
	...
	public static class ConnectedSearcher implements SearchInterface {
		...
		public ConnectedSearcher(String t) {
			target = t;
			found = false;
		}
