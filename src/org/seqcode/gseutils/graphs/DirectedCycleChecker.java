...
public class DirectedCycleChecker implements CycleChecker {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(args[0] + " " + (checker.containsCycle() ? "is cyclic" : "isn't cyclic"));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.seqcode.gseutils.graphs.CycleChecker#containsCycle()
	 */
	 ...
	 * 
	 * @see
	 * org.seqcode.gseutils.graphs.CycleChecker#checkCycleWithEdge(java.lang.
