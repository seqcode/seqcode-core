...
public class ArgParser {
	...
	public boolean hasKey(String k) {
		return keyedValues.containsKey(k);
	}

	public List<String> getUnkeyedValues() {
		return new LinkedList<String>(unkeyedValues);
	}
	...
	public List<String> getOrderedKeys() {
		return new LinkedList<String>(orderedKeys);
	}

	public int getNumKeyedValues() {
		return keyedValues.size();
	}

	public int getNumUnkeyedValues() {
		return unkeyedValues.size();
	}
