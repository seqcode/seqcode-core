...
/**
 * The contents of this class are just helper functions -- to check if all
 * required fields are present, and to print errors if they are not.
 * 
 * In general, all a subclass needs to do is to extend ArgumentModel, provide a
 * reasonable default constructor if necessary, and then make sure the Class
 * object of the subclass is passed into the appropriate Arguments object.
 * Arguments.java does all the parsing for us.
 * 
 * @author tdanford
 */
