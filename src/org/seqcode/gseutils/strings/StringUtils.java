...
public class StringUtils {
	 ...
	 * times of the String <tt>paddingPattern</tt> from the left
	 * (<tt>directionOfPadding = -1</tt>) or the right
	 * (<tt>directionOfPadding = 1</tt>)
	 * 
	 * @param s
	 *            String to be padded
	 * @param paddingPattern
	 *            padding pattern
	 * @param numReps
	 *            number of times that the padding will be performed
	 * @param directionOfPadding
	 *            direction of padding. <br>
	 *            <tt> Left  = -1  </tt> <br>
	 *            <tt> Right =  1  </tt>
	 * @return
	 */
	public static String padString(String s, String paddingPattern, int numReps, int directionOfPadding) {
		...
		default:
			throw new IllegalArgumentException(
					"Direction of padding must be either from the left end " + "of String (-1) or the right (1).");
		}
