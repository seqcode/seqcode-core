 ...
 */
public class AttributeBagging
  extends RandomizableParallelIteratedSingleClassifierEnhancer 
  implements WeightedInstancesHandler, AdditionalMeasureProducer,
             TechnicalInformationHandler, PartitionGenerator, Aggregateable<AttributeBagging> {
	
	
  public Classifier getClassifier(int ind){
	  return m_Classifiers[ind];
  }
  ...
  public static void main(String [] argv) {
    runClassifier(new AttributeBagging(), argv);
  }
   ...
   */
  @Override
  public AttributeBagging aggregate(AttributeBagging toAggregate) throws Exception {
