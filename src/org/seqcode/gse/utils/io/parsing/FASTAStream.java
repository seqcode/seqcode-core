 ...
 */
package org.seqcode.gse.utils.io.parsing;
 ...
 */
public class FASTAStream implements Iterator<Pair<String,String>>, org.seqcode.gse.utils.Closeable {
    ...
    /* (non-Javadoc)
     * @see org.seqcode.gse.utils.Closeable#close()
     */
    public void close() {
        if (isClosed()) {return;}
        try { 
    ...
    /* (non-Javadoc)
     * @see org.seqcode.gse.utils.Closeable#isClosed()
     */
