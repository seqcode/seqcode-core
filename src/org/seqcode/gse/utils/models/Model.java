...
import org.seqcode.gse.utils.json.JSONArray;
import org.seqcode.gse.utils.json.JSONException;
import org.seqcode.gse.utils.json.JSONObject;
	...
	public JSONObject asJSON() { 
		...
		for(int i = 0; i < fs.length; i++) {
			...
			if(!isStatic) { 
				...
				} catch (org.seqcode.gse.utils.json.JSONException e) {
