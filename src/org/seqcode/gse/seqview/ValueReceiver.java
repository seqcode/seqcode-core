...
public interface ValueReceiver<X, Y> extends Startable<X> {
    ...
    public static class MappedWrapper<Base,Input,Output> implements ValueReceiver<Base,Input> {
        ...
        /* (non-Javadoc)
         * @see org.seqcode.gse.hyperdriveson.models.ValueReceiver#finish()
         */
        public void finish() { inner.finish(); }

        /* (non-Javadoc)
         * @see org.seqcode.gse.hyperdriveson.models.ValueReceiver#addValue(java.lang.Object)
         */
        ...
        /* (non-Javadoc)
         * @see org.seqcode.gse.hyperdriveson.models.Startable#start(java.lang.Object)
         */
