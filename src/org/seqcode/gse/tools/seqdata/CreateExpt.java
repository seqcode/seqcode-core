    		...
    		try{
		        ...
		        if(!newExpt){
		        	...
		        	if(!(expt.getName().equals(alignpieces[0]) && expt.getReplicate().equals(alignpieces[1]) &&
		        		...
		        		expt.getExptCondition().getDBID()==core.loadExptCondition(conditionstring, true, false).getDBID() &&
		        		expt.getExptTarget().getDBID()==core.loadExptTarget(targetstring, true, false).getDBID() && 
