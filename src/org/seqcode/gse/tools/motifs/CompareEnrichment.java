...
import org.seqcode.gse.tools.motifs.*;
...
//import org.seqcode.gse.utils.probability.Binomial;

/** Compare the frequencies of a set of motifs between two FASTA files
 * usage:
 *   java org.seqcode.gse.tools.motifs.CompareEnrichment --species "$SC;SGDv2" [--first foo.fasta] [--second bar.fasta]
 *
