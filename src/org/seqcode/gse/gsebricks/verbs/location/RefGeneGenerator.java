...
import org.seqcode.gse.utils.database.*;
 ...
 *   
 *   reads the properties file org.seqcode.gse.gsebricks.verbs.gene_names which is formatted as 
...
public class RefGeneGenerator<X extends Region> 
    ...
    public void setGenome(Genome g, String t) { 
        genome = g;
        ResourceBundle res = ResourceBundle.getBundle("org.seqcode.gse.gsebricks.gene_names");
