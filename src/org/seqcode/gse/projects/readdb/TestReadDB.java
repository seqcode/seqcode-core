package org.seqcode.gse.projects.readdb;
...
public class TestReadDB {
    ...
    @Test public void testDelete2() throws IOException, ClientException {
        Client c = new Client(hostname, portnum, user, passwd);
    ...
    @Test public void testDelete3() throws IOException, ClientException {
        Client c = new Client(hostname, portnum, user, passwd);
    ...
    public static void main(String args[]) {
        ...
        org.junit.runner.JUnitCore.main("org.seqcode.gse.projects.readdb.TestReadDB");
    }
}