 ...
 * <pre>java org.seqcode.gse.projects.readdb.Server --datadir /path/to/data</pre>
 *
...
public class Server {
    ...
    */
    ...
    public Server () {
        ...
        topdir = "/tmp";
        keepRunning = true;
        logger = Logger.getLogger("org.seqcode.gse.projects.readdb.Server");
    ...
    public void printHelp() {
        ...
        System.out.println("usage: java org.seqcode.gse.projects.readdb.Server --datadir /path/to/datadir --port 52000");
