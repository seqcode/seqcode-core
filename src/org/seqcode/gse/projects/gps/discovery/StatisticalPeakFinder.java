...
import org.seqcode.gse.projects.gps.BackgroundCollection;
...
import org.seqcode.gse.projects.gps.PoissonBackgroundModel;
import org.seqcode.gse.projects.gps.ReadHit;
import org.seqcode.gse.projects.gps.features.ClipSeqPeak;
import org.seqcode.gse.projects.gps.features.EnrichedFeature;
import org.seqcode.gse.projects.gps.features.Feature;
import org.seqcode.gse.projects.gps.utilities.AnnotationLoader;
...
public abstract class StatisticalPeakFinder extends SingleConditionFeatureFinder{
	...
	protected double estimateScalingFactor(List<PairedCountData> scalingData){
		...
		if(scalingData==null || scalingData.size()==0)
			return 1;
		DataFrame df = new DataFrame(org.seqcode.gse.projects.gps.PairedCountData.class, scalingData.iterator());
