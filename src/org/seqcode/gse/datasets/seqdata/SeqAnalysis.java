...
public class SeqAnalysis implements Comparable<SeqAnalysis> {
    ...
    public void store() throws SQLException {
        ...
        PreparedStatement ps = cxn.prepareStatement(String.format(q,org.seqcode.gse.utils.database.Sequence.getInsertSQL(cxn, "chipseqanalysis_id")));
        ps.setString(1, name);
        ...
        ps.execute();
        ps.close();
        String sql = org.seqcode.gse.utils.database.Sequence.getLastSQLStatement(cxn, "chipseqanalysis_id");
