...
import org.seqcode.utils.json.JSONArray;
import org.seqcode.utils.json.JSONException;
import org.seqcode.utils.json.JSONObject;
	...
	public JSONObject asJSON() { 
		...
		for(int i = 0; i < fs.length; i++) {
			...
			if(!isStatic) { 
				...
				} catch (org.seqcode.utils.json.JSONException e) {
