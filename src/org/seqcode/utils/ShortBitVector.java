...
public class ShortBitVector implements Comparable<ShortBitVector>, BitVector {
    ...
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#toHexString()
	 */
    ...
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#isOn(int)
	 */
    public boolean isOn(int index) { return array[index] == ON; }
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#isOff(int)
	 */
    public boolean isOff(int index) { return array[index] == OFF; }
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#length()
	 */
    ...
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#countOnBits()
	 */
    ...
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#turnOnBit(int)
	 */
    public void turnOnBit(int index) { array[index] = ON; }
    /* (non-Javadoc)
	 * @see org.seqcode.utils.BitVector#turnOffBit(int)
	 */
