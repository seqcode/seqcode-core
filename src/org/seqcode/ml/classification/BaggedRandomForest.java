 ...
 */
public class BaggedRandomForest extends AbstractClassifier
	...
	/**
	 * Number of features to consider in random feature selection. If less than
	 * 1 will use int(log_2(M)+1) )
	 */
	...
	public Enumeration<Option> listOptions() {
		...
		newVector.addElement(
				new Option("\tNumber of features to consider (<1=int(log_2(#predictors)+1)).\n\t(default 0)", "K", 1,
						"-K <number of features>"));
