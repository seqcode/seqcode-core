...
public class CorrelationSimilarity {
		...
		try {
			...
			for (int i = 0; i < names.size(); i++) {
				for (int j = i + 1; j < names.size(); j++) {
					...
					// out2.print(" ");
					double value = convertCorrelationToSimilarity(
							computeSimilarity2(valuemap.get(names.get(i)), valuemap.get(names.get(j))));
					out.print(value);
					out.println();
					if (value > -0.1) {
						counts[0]++;
	...
	public static double computeSimilarity2(List<Double> x, List<Double> y) {
		...
		return ((n * xy_sum - x_sum * y_sum)
				/ (Math.sqrt((n * xx_sum - x_sum * x_sum) * (n * yy_sum - y_sum * y_sum))));
	}
	...
	public static void main(String[] args) {
		/*
		 * toFile(fromFile("/Users/reeder/tmp/lineage430ab_GCRMA_nohead.txt"),
		 * "/Users/reeder/tmp/Complete_Similarities.txt");
		 */
		/*
		 * convertFile(
		 * "/afs/csail.mit.edu/u/c/ccr/psrg/projects/Corinna_Macklis/Data/lineage430ab_GCRMA_similarities.txt",
		 * "/Users/reeder/Corinna_similarities.txt");
		 */
		/*
		 * generatePrefFile2(
		 * "/Users/reeder/Macklis_Proj/Complete_sims_reduced2.txt",
		 * "/Users/reeder/Macklis_Proj/Complete_prefs_red2.txt");
		 */
		/*
		 * reduceFile("/Users/reeder/Macklis_Proj/Complete_similarities.txt",
		 * "/Users/reeder/Macklis_Proj/Complete_sims_reduced2.txt");
		 */
