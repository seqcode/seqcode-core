...
public class APCluster {
	...
	public static double cluster(Vector<Clusterable> objects, SimilarityMeasure<Clusterable> s, double lam, int convit,
			int maxit) {
		...
		/*
		 * System.out.println("a:"); print(a); System.out.println();
		 * System.out.println("r:"); print(r); System.out.println();
		 */
		...
		while (!done) {
			...
			for (int i = 0; i < s.size(); i++) {
				...
				for (int k = 0; k < s.size(); k++) {
					...
					if (k == i1) {
						...
						System.err.println(
								"R " + objects.get(i).name() + " to " + objects.get(k).name() + ": " + message);
			...
			/*
			 * if (false) { System.out.println("max1: "+max1);
			 * System.out.println("max2: "+max2); System.out.println("i1: "+i1);
			 * for (int i=0; i<s.size(); i++) { for (int j=0; j<s.size(); j++) {
			 * if (!s.exists(objects.get(i), objects.get(j))) continue;
			 * System.out.print(r.get(objects.get(i).name()+"SEP"+objects.get(j)
			 * .name())); System.out.print("\t"); } System.out.println(); } }
			 * 
			 * /* if (it==0) { System.out.println("max1: "+max1);
			 * System.out.println("max2: "+max2);
			 * System.out.println("r("+it+"):"); print(r); System.out.println();
			 * }
			 */
			...
			for (int k = 0; k < s.size(); k++) {
				...
				for (int i = 0; i < s.size(); i++) {
					...
					if (i == k) {
						...
						System.err.println(
								"A " + objects.get(i).name() + " to " + objects.get(k).name() + ": " + message);
			...
			/*
			 * System.out.println("e("+it+"):"); print(e);
			 */
	...
	/**
	 * argv[0] = similarities file argv[1] = preference value argv[2] = results
	 * file argv[3] = indices file
	 * 
	 * @param argv
	 * @throws Exception
	 */
