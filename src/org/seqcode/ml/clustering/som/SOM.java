package org.seqcode.ml.clustering.som;

/**
 * This class is adapted from the Java Machine Learning Library.
 * Copied here to allow easier changes to the underlying implementation. 
 * License information for the javaml library as follows:
 * 
...
/**
 * SOM: An implementation of the Self Organizing Maps algorithm as proposed by
 * Kohonen.
 * 
...
public class SOM implements Clusterer {
	 ...
	 */
	private WeightVectors doLabeling(WeightVectors wVector, InputVectors iVector, Dataset data,
			Vector<Dataset> clusters) {
